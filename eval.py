...
if __name__ == '__main__':
    ...
    parser.add_argument("--list", default='/root/Dataset/VOC/VOCdevkit/VOC2012/ImageSets/Segmentation/train.txt', type=str)
    parser.add_argument("--predict_dir", default='./output/train/file', type=str)
    parser.add_argument("--gt_dir", default='/root/Dataset/VOC/VOCdevkit/VOC2012/SegmentationClass', type=str)
    parser.add_argument('--logfile', default='./evallog.txt', type=str)
    parser.add_argument('--comment', default='ori_wseg', type=str)
